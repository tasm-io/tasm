...
it('parses a full program', () => {
  ...
  statements: [
    ...
    Byte {
      ...
      value: Integer { source: { offset: 21, line: 2, column: 8 }, value: 0 }
    },
    Ascii { source: { offset: 25, line: 3, column: 3 }, value: 'Hey' },
    Asciiz {
    ...
    Org {
      ...
      addr: Integer { source: { offset: 73, line: 7, column: 7 }, value: 10 }
    },
    Byte {
      source: { offset: 95, line: 8, column: 3 },
      value: Integer { source: { offset: 100, line: 8, column: 8 }, value: 5 }
    },
    Org {
      source: { offset: 108, line: 9, column: 3 },
      addr: Integer { source: { offset: 112, line: 9, column: 7 }, value: 0 }
    },
    Instruction {
      ...
      operands: [
        Register {
          source: { offset: 120, line: 10, column: 7 },
          name: 'al'
        },
        Integer {
          source: { offset: 124, line: 10, column: 11 },
          value: 100
        }
      ]
    },
    Instruction {
      source: { offset: 131, line: 11, column: 3 },
      opcode: 'ret',
      operands: []
    },
    Instruction {
      source: { offset: 144, line: 12, column: 3 },
      opcode: 'iret',
      operands: []
    },
    Instruction {
      source: { offset: 166, line: 14, column: 3 },
      opcode: 'mov',
      operands: [
        RegisterOffsetAddress {
          source: { offset: 170, line: 14, column: 7 },
          register: Register {
            source: { offset: 171, line: 14, column: 8 },
            name: 'al'
          },
          offset: Integer {
            source: { offset: 174, line: 14, column: 11 },
            value: 3
          }
        },
        Integer {
          source: { offset: 178, line: 14, column: 15 },
          value: 4
        }
      ]
    },
    Instruction {
      source: { offset: 182, line: 15, column: 3 },
      opcode: 'mov',
      operands: [
        RegisterAddress {
          source: { offset: 186, line: 15, column: 7 },
          register: Register {
            source: { offset: 187, line: 15, column: 8 },
            name: 'al'
          }
        },
        Integer {
          source: { offset: 192, line: 15, column: 13 },
          value: 3
        }
      ]
    },
    Instruction {
      source: { offset: 196, line: 16, column: 3 },
      opcode: 'mov',
      operands: [
        RegisterAddress {
          source: { offset: 200, line: 16, column: 7 },
          register: Identifier {
            source: { offset: 201, line: 16, column: 8 },
            name: 'X'
          }
        },
        Integer {
          source: { offset: 205, line: 16, column: 12 },
          value: 3
        }
      ]
    },
    Instruction {
      source: { offset: 209, line: 17, column: 3 },
      opcode: 'mov',
      operands: [
        Register {
          source: { offset: 213, line: 17, column: 7 },
          name: 'al'
        },
        RegisterOffsetAddress {
          source: { offset: 217, line: 17, column: 11 },
          register: Register {
            source: { offset: 218, line: 17, column: 12 },
            name: 'al'
          },
          offset: Integer {
            source: { offset: 221, line: 17, column: 15 },
            value: 3
          }
        }
      ]
    ...
    Instruction {
      source: { offset: 226, line: 18, column: 3 },
      opcode: 'mov',
      operands: [
        Register {
          source: { offset: 230, line: 18, column: 7 },
          name: 'bl'
        },
        RegisterAddress {
          source: { offset: 234, line: 18, column: 11 },
          register: Register {
            source: { offset: 235, line: 18, column: 12 },
            name: 'al'
          }
        }
      ]
    ...
    Instruction {
      source: { offset: 241, line: 19, column: 3 },
      opcode: 'mov',
      operands: [
        Register {
          source: { offset: 247, line: 19, column: 9 },
          name: 'cl'
        },
        DirectAddress {
          source: { offset: 253, line: 19, column: 15 },
          value: Integer {
            source: { offset: 254, line: 19, column: 16 },
            value: 40
          }
        }
      ]
